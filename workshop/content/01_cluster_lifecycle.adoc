...
If the deployment fails, please re-try in a different AWS zone (us-west-1)
====
...
. Open a terminal window and use SSH to access the `bastion` VM of your _managed_ OpenShift cluster. You can also use the Terminal within the Bastion host.
