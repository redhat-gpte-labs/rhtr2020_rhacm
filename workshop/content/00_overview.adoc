...
The labs in this course cover many of the basic functions of Red Hat^(R)^ Advanced Cluster Management for Kubernetes (RHACM).
...
[NOTE]
====
All of the information you need to complete these labs is included in the provisioning emails.
For your convenience, some of the information is also included below and throughout this lab guide. 
====

* Your GUID is: *%guid%*
* Your OpenShift username is: *admin*
* Your OpenShift password is provided in the ACM Hub provisioning email

* The OpenShift API is at: *%api_url.stdout%*
* The OpenShift Web Console is at: *%web_console_url.stdout%*
